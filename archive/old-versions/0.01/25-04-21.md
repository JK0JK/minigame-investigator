...
![Text says "Alpha Update v0.01" with four sprites - a ghost, a small Freddy, the Purple Guy and a purple car - between the words.](Update%200.01%20thumbnail.png)

We are happy to announce that the first patch is done! For now it is only a cosmetic patch but we still have much to come! You can download the patch .ups [here]((v0.01%20ALPHA)Five%20Nights%20at%20Freddys%20-%20The%20Minigame%20Investigator.ups)!
